 ...
 */
#define USB_CFG_CLOCK_KHZ      F_CPU/1000 //F_CPU=16.5 MHz
...
#define  USB_CFG_VENDOR_ID       0xc0, 0x16 /* = 0x16c1 = 5824 = voti.nl */
 ...
 */
#define USB_CFG_VENDOR_NAME     'k', '0', 's', 'i', 'g'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'T', 'e', 's', 't', 'V', 'U', 'S', 'B', '-', 'H', 'i', 'd'
